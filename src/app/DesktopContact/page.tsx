...
const page = () => {
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[882px] relative overflow-hidden bg-white">
    <div className="w-[1440px] h-[882px] absolute left-0 top-0">
      <div className="w-[1440px] h-[853px] absolute left-0 top-0">
        <div className="w-[632px] h-[612px] absolute left-[742px] top-[117px]">
          ...
          >
            <circle cx="242.429" cy="242.031" r="242.031" fill="#FFE9EA"></circle></svg>
            <svg
            width="78"
            height="79"
            viewBox="0 0 78 79"
          ...
          >
            ...
            className="w-[571px] h-[826px] absolute left-[33.26px] top-[-56.74px] object-cover"
          /><svg
            width="31"
            height="31"
            viewBox="0 0 31 31"
          ...
          >
            ...
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="8.32313" cy="8.10731" r="7.38758" fill="#977DF4"></circle></svg>
            <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
            ...
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="8.30946" cy="8.16688" r="7.38758" fill="#977DF4"></circle>
          </svg>
        </div>
      </div>
      <div className="w-[1440px] h-[882px] absolute left-0 top-0 overflow-hidden"></div>
    </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="flex-grow-0 flex-shrink-0 text-[58px] font-bold text-left text-[#252b42]">
            <span className="flex-grow-0 flex-shrink-0 text-[58px] font-bold text-left text-[#252b42]"
              >Get in touch </span><br /><span
              className="flex-grow-0 flex-shrink-0 text-[58px] font-bold text-left text-[#252b42]"
              >today!</span>
          </p>
          ...
          <div className="flex-grow-0 flex-shrink-0 w-[242px] h-[84px] relative overflow-hidden">
            <p className="absolute left-0 top-0 text-2xl font-bold text-left text-[#252b42]">
              Phone : +451 215 215
            </p>
            <p className="absolute left-0 top-[52px] text-2xl font-bold text-left text-[#252b42]">
              Fax : +451 215 215
            </p>
          </div>
          <div
  ...
  <div className="self-stretch flex-grow-0 flex-shrink-0 h-[814px] relative overflow-hidden bg-white">
    <div
      className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 overflow-hidden gap-20 py-28"
    >
      <div
      ...
      >
        ...
        >
          ...
          <p className="flex-grow-0 flex-shrink-0 text-[40px] font-bold text-center text-[#252b42]">
            <span className="flex-grow-0 flex-shrink-0 text-[40px] font-bold text-center text-[#252b42]"
              >We help small businesses </span><br /><span
              className="flex-grow-0 flex-shrink-0 text-[40px] font-bold text-center text-[#252b42]"
              >with big ideas</span>
          </p>
        </div>
      </div>
      <div className="flex justify-start items-center flex-grow-0 flex-shrink-0">
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[327px]">
          <div
            className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[328px] relative overflow-hidden gap-[15px] px-10 py-[50px] bg-white"
          >
            <svg
              width="73"
              height="72"
            ...
            <div className="flex-grow-0 flex-shrink-0 w-[216px] h-12 relative overflow-hidden">
              <p className="absolute left-0 top-0 text-sm font-bold text-center text-[#252b42]">
                georgia.young@example.com
              </p>
              <p className="absolute left-5 top-6 text-sm font-bold text-center text-[#252b42]">
            ...
            <div
              className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 px-9 py-[15px] rounded-[37px] border border-[#23a6f0]"
            >
        ...
        <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[329px]">
          <div
            className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[328px] relative overflow-hidden gap-[15px] px-10 py-20 bg-[#252b42]"
          >
            <svg
              width="73"
              height="72"
            ...
            <div className="flex-grow-0 flex-shrink-0 w-[216px] h-12 relative overflow-hidden">
              <p className="absolute left-0 top-0 text-sm font-bold text-center text-white">
                georgia.young@example.com
              </p>
              <p className="absolute left-5 top-6 text-sm font-bold text-center text-white">
                georgia.young@ple.com
              </p>
            </div>
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[348px] relative overflow-hidden bg-white">
    <div
    ...
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="absolute left-[683.79px] top-[-8.6px]"
      preserveAspectRatio="none"
    >
      <path
