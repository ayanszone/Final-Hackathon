...
const page = () => {
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-96 relative overflow-hidden bg-white">
    ...
    >
      <g clipPath="url(#clip0_232_1005)">
        <rect width="1440" height="352" fill="white" fillOpacity="0.5"></rect>
      </g>
      <defs>
        <clipPath id="clip0_232_1005">
          <rect width="1440" height="352" fill="white"></rect>
        </clipPath>
      </defs>
    </svg>
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[530px] relative overflow-hidden bg-white">
    <div className="w-[1440px] h-[530px] absolute left-0 top-0 overflow-hidden">
      <div className="w-[1440px] h-[530px] absolute left-0 top-0 overflow-hidden">
        ...
        height={260}
        alt='Image'
          src="/unsplash_mcsdtbwxuzu.jpeg"
          className="w-[361px] h-[260px] absolute left-[1439px] top-[269px] object-cover"
        />
      </div>
    </div>
  </div>
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[1759px] relative overflow-hidden bg-white">
    <div
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[442px] relative overflow-hidden bg-white">
    <div
      className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 overflow-hidden gap-24 py-20"
    >
      <div
