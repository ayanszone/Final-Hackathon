...
const page = () => {
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[729px] relative overflow-hidden bg-white">
    <div className="w-[1440px] h-[729px] absolute left-0 top-0">
      <div className="w-[1440px] h-[700px] absolute left-0 top-0">
        <div className="w-[632px] h-[612px] absolute left-[742px] top-[117px]">
          <svg
            width="485"
            height="485"
            viewBox="0 0 485 485"
            ...
            className="absolute left-[57.69px] top-[-0.7px]"
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="242.428" cy="242.031" r="242.031" fill="#FFE9EA"></circle></svg>
            <svg
            width="78"
            height="79"
            viewBox="0 0 78 79"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute left-[-0.7px] top-[11.26px]"
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="38.6969" cy="39.6578" r="38.6969" fill="#FFE9EA"></circle></svg>
            <Image
            width={571}
            height={668}
            alt='Image'
            src="/technology-1.png"
            className="w-[571px] h-[668px] absolute left-[33.26px] top-[-56.74px] object-cover"
          /><svg
            width="31"
            height="31"
            viewBox="0 0 31 31"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute left-[553.72px] top-[246.96px]"
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="15.5479" cy="15.7871" r="15.127" fill="#FFE9EA"></circle></svg>
            <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute left-[576.23px] top-[121.02px]"
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="8.32264" cy="8.10731" r="7.38758" fill="#977DF4"></circle></svg>
            <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute left-[23.22px] top-[408.08px]"
            preserveAspectRatio="xMidYMid meet"
          >
            <circle cx="8.30897" cy="8.16688" r="7.38758" fill="#977DF4"></circle>
          </svg>
        </div>
      </div>
      <div className="w-[1440px] h-[729px] absolute left-0 top-0 overflow-hidden"></div>
    </div>
    <div className="w-[1322px] h-[91px] absolute left-[59px] top-0 overflow-hidden">
      <div className="w-[1322px] h-[91px] absolute left-0 top-0 overflow-hidden">
        ...
        <div className="w-[815px] h-[58px] absolute left-[364px] top-4 overflow-hidden">
          ...
          >
            ...
            <div className="flex-grow-0 flex-shrink-0 w-[59px] h-6 relative overflow-hidden">
              <div className="w-[59px] h-6 absolute left-0 top-0 overflow-hidden">
                <Link href="Products"><p className="absolute left-0 top-0 text-sm font-bold text-center text-neutral-500">
                  Product
                </p></Link>
              </div>
            </div>
          ...
          <div className="flex justify-start items-center absolute left-[515px] top-[3px] gap-[45px]">
    ...
    <div
      className="flex flex-col justify-start items-start w-[1050px] absolute left-[195px] top-[104px] overflow-hidden gap-20 py-28"
    >
      <div
        className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-[30px]"
      >
        <div
        ...
        >
          ...
          <p
            className="flex-grow-0 flex-shrink-0 w-[542px] text-[58px] font-bold text-left text-[#252b42]"
          >
            ABOUT US
          </p>
          ...
          <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-2.5">
            <div
              className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 px-10 py-[15px] rounded-[5px] bg-[#23a6f0]"
            >
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[236px] relative overflow-hidden bg-white">
    <div
      className="flex flex-col justify-start items-center w-[1440px] absolute left-0 top-0 overflow-hidden py-6"
    >
      <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-[1018px] gap-[60px]">
        <div
          className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[394px] gap-20 py-6"
        >
          <div
            className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[394px] relative gap-6"
          >
            <p className="flex-grow-0 flex-shrink-0 text-sm text-left text-[#e74040]">
              Problems trying
            </p>
            <p
              className="flex-grow-0 flex-shrink-0 w-[394px] text-2xl font-bold text-left text-[#252b42]"
            >
        ...
        <div
          className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[529px] relative overflow-hidden gap-[49px]"
        >
          <p className="flex-grow-0 flex-shrink-0 w-[545px] text-sm text-left text-neutral-500">
            Problems trying to resolve the conflict between the two major realms of classNameical
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[264px] relative overflow-hidden bg-white">
    <div
      className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 gap-[50px] py-20"
    >
      <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-[30px]">
        <div
          className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[238px] relative"
        >
        ...
        <div
          className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[241px] relative"
        >
          <p className="flex-grow-0 flex-shrink-0 text-[58px] font-bold text-center text-[#252b42]">
            150K
          </p>
        ...
        <div
          className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-60 relative"
        >
          <p className="flex-grow-0 flex-shrink-0 text-[58px] font-bold text-center text-[#252b42]">
            15
          </p>
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[764px] relative overflow-hidden bg-white">
    <div className="w-[1050px] h-[764px] absolute left-[195px] top-0 overflow-hidden">
      <div
        className="w-[989px] h-[540px] absolute left-[31px] top-28 overflow-hidden rounded-[20px] bg-white"
      >
        <div className="w-[989px] h-[540px] absolute left-0 top-0 overflow-hidden">
          <Image
            width={989}
            height={540}
            alt='Image'
            src="/unsplash_t_qe4qlmivq.jpeg"
            className="w-[989px] h-[540px] absolute left-[-0.5px] top-[-1px] object-cover"
          />
          <div
            className="w-[989px] h-[540px] absolute left-0 top-0 overflow-hidden background: linear-gradient(to bottom, rgba(0,0,0,0) 14.58%, rgba(56,56,56,0.84) 100%)"
          ></div>
        </div>
        <div
          className="flex justify-start items-center absolute left-[448px] top-56 overflow-hidden px-[36.79999923706055px] py-[34.79999923706055px] rounded-[73.6px] bg-[#23a6f0]"
        >
          <svg
            width="20"
            height="24"
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="flex-grow-0 flex-shrink-0 w-[19px] h-[23px] relative"
            preserveAspectRatio="xMidYMid meet"
          >
            <g clipPath="url(#clip0_7008_171)">
              <path
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[826px] relative overflow-hidden bg-white">
    <div
      className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 overflow-hidden gap-28 py-28"
    >
      <div
      ...
      >
        <div
          className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 overflow-hidden"
        >
          <div
            className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[316px] relative overflow-hidden bg-white"
          >
            <div className="self-stretch flex-grow-0 flex-shrink-0 h-[231px] relative overflow-hidden">
              <Image
                width={316}
                height={231}
                alt='Image'
                src="/team-1-user-1.jpeg"
                className="w-[316px] h-[231px] absolute left-[-1px] top-[-1px] object-cover"
              />
            </div>
            <div
              className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[316px] relative overflow-hidden gap-2.5 p-[30px]"
            >
        ...
        <div
          className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[329px] overflow-hidden"
        >
          <div
            className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[329px] relative overflow-hidden bg-white"
          >
            <div className="self-stretch flex-grow-0 flex-shrink-0 h-[231px] relative overflow-hidden">
              <Image
                width={316}
                height={231}
                alt='Image'
                src="/team-1-user-2.jpeg"
                className="w-[316px] h-[231px] absolute left-[-1px] top-[-1px] object-cover"
              />
            </div>
            <div
              className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[332px] relative overflow-hidden gap-2.5 p-[30px]"
            >
              <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-[#252b42]">
                Username
              </p>
          ...
          >
            <div className="self-stretch flex-grow-0 flex-shrink-0 h-[231px] relative overflow-hidden">
              <Image
                ...
                height={231}
                alt='Image'
                src="/team-1-user-3.jpeg"
                className="w-[329px] h-[231px] absolute left-[-1px] top-[-1px] object-cover"
              />
            </div>
            <div
              className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[330px] relative overflow-hidden gap-2.5 p-[30px]"
            >
              <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-center text-[#252b42]">
                Username
              </p>
  ...
  <div
    className="flex-grow-0 flex-shrink-0 w-[1440px] h-[479px] relative overflow-hidden bg-neutral-50"
  >
    <div
      className="flex flex-col justify-start items-center w-[1050px] absolute left-[195px] top-0 overflow-hidden gap-6 py-20"
    >
      <div
        className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[864px] overflow-hidden"
      >
        <div
          className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[864px] relative overflow-hidden gap-[30px]"
        >
          <p className="flex-grow-0 flex-shrink-0 text-[40px] font-bold text-left text-[#252b42]">
            Big Companies Are Here
          </p>
          <p className="flex-grow-0 flex-shrink-0 w-[547px] text-sm text-center text-neutral-500">
            <span className="flex-grow-0 flex-shrink-0 w-[547px] text-sm text-center text-neutral-500"
              >Problems trying to resolve the conflict between </span>
              <br /><span
              className="flex-grow-0 flex-shrink-0 w-[547px] text-sm text-center text-neutral-500"
              >the two major realms of classNameical physics: Newtonian mechanics
            </span>
          </p>
        </div>
      ...
      <div
        className="flex justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-[30px] py-[50px]"
      >
        <div
        ...
        >
          <svg
            ...
            preserveAspectRatio="none"
          >
            <g clipPath="url(#clip0_232_351)">
              <path
                d="M26.5557 3.79318L19.5871 5.25682L19.5549 27.9114C19.5549 32.0955 22.7415 34.8 26.9741 34.8C29.3238 34.8 31.0458 34.3705 31.9954 33.8614V28.4841C31.078 28.85 26.5718 30.1546 26.5718 25.9864V15.9318H31.9954V9.91818H26.5718L26.5557 3.79318ZM40.8952 12.0023L40.4607 9.91818H34.2807V34.2909H41.4102V17.8886C43.1001 15.6932 45.9487 16.1227 46.866 16.4091V9.91818C45.9004 9.58409 42.569 8.96364 40.8952 12.0023ZM55.7498 0.5L48.5719 2.01136V7.77045L55.7498 6.25909V0.5ZM7.22709 17.0932C7.22709 15.9955 8.16053 15.5659 9.65725 15.55C11.8299 15.55 14.598 16.2023 16.7707 17.3636V10.7136C14.4049 9.79091 12.0391 9.425 9.67334 9.425C3.87959 9.425 0.0170898 12.4159 0.0170898 17.4114C0.0170898 25.2386 10.8804 23.9659 10.8804 27.3386C10.8804 28.6432 9.73772 29.0727 8.14443 29.0727C5.77865 29.0727 2.72084 28.1023 0.322871 26.8136V33.1773C2.97834 34.3068 5.666 34.7841 8.12834 34.7841C14.0669 34.7841 18.1547 32.2705 18.1547 27.1796C18.1547 18.7636 7.22709 20.275 7.22709 17.0932ZM103.001 22.3909C103.001 15.1523 99.4604 9.44091 92.6688 9.44091C85.8773 9.44091 81.7412 15.1523 81.7412 22.3432C81.7412 30.8545 86.6176 34.7841 93.5701 34.7841C96.9819 34.7841 99.5408 34.0205 101.488 32.9545V27.6409C99.5408 28.6114 97.3038 29.2 94.4713 29.2C91.6871 29.2 89.2409 28.2295 88.919 24.9205H102.904C102.937 24.5545 103.001 23.075 103.001 22.3909ZM88.8546 19.7182C88.8546 16.5364 90.8341 15.2 92.6205 15.2C94.3748 15.2 96.2416 16.5364 96.2416 19.7182H88.8546ZM70.6848 9.44091C67.8844 9.44091 66.0819 10.7455 65.0841 11.6523L64.714 9.90227H58.4213V42.4841L65.5669 40.9886L65.583 33.0023C66.613 33.75 68.1419 34.7841 70.6365 34.7841C75.7543 34.7841 80.4215 31.0932 80.4215 22.1205C80.4376 13.9114 75.706 9.44091 70.6848 9.44091ZM68.9788 28.9296C67.3051 28.9296 66.3073 28.325 65.6152 27.5932L65.5669 17.0932C66.3073 16.2818 67.3373 15.6932 68.9788 15.6932C71.586 15.6932 73.3885 18.5886 73.3885 22.2795C73.4046 26.0818 71.6343 28.9296 68.9788 28.9296ZM48.588 34.2909H55.7658V9.91818H48.588V34.2909Z"
                fill="#737373"
              ></path>
            </g>
            <defs>
        ...
        >
          <svg
            ...
            preserveAspectRatio="none"
          >
            <g clipPath="url(#clip0_232_354)">
              <path
                d="M29.8872 22.9882C29.7706 26.6263 31.6044 28.2373 31.6497 29.2605C31.6281 29.4687 31.5566 29.6688 31.441 29.844C31.3255 30.0192 31.1693 30.1645 30.9856 30.2676L28.912 31.7068C28.6437 31.8933 28.3274 32.0002 28 32.0152C27.9304 32.0119 26.6733 32.3091 24.6824 27.9016C23.4677 29.405 21.9223 30.6128 20.1643 31.4327C18.4063 32.2526 16.4824 32.6628 14.54 32.6319C11.9027 32.7749 4.75553 31.1478 5.12326 23.6034C4.86569 17.4548 10.6408 13.6352 16.6135 13.9581C17.7636 13.9613 20.1125 14.0175 24.2256 14.9652V12.4562C24.6613 8.20619 21.8443 4.90862 16.9666 5.40334C16.5778 5.40494 13.8239 5.32303 9.54083 7.02723C8.34855 7.57013 8.19628 7.48018 7.79939 7.48018C6.59902 7.48018 7.0931 4.03002 7.32313 3.59313C8.16712 2.56515 13.1322 0.645723 18.005 0.673028C21.2631 0.387326 24.5037 1.38434 27.0264 3.44857C28.0519 4.58591 28.8343 5.91753 29.3262 7.36301C29.8182 8.8085 30.0096 10.3379 29.8889 11.8587L29.8872 22.9882ZM15.8877 28.1907C21.1412 28.1153 23.3654 24.9831 23.8724 23.2966C24.2709 21.6824 24.2045 20.6608 24.2045 18.8956C22.638 18.5229 20.3831 18.1166 17.796 18.1133C15.3418 17.9302 10.8595 19.0176 11.0344 23.295C10.8335 25.9918 12.8358 28.3385 15.8877 28.1907ZM43.5757 31.8931C42.3024 32.0087 41.7095 31.1125 41.5216 30.2274L33.4543 3.78106C33.2972 3.33453 33.1935 2.87355 33.1433 2.40292C33.1136 2.2089 33.1627 2.01109 33.28 1.85298C33.3972 1.69486 33.573 1.58936 33.7686 1.55966C33.8075 1.55323 33.4236 1.55966 37.373 1.55966C38.7953 1.41831 39.2586 2.52821 39.406 3.22531L45.1924 25.8457L50.5641 3.22531C50.65 2.70811 51.0404 1.44723 52.6376 1.58054H55.4175C55.769 1.55163 57.2172 1.50023 57.4715 3.24619L62.8854 26.1557L68.8581 3.24619C68.9358 2.89603 69.2987 1.41992 70.9122 1.58054H74.1067C74.2444 1.55966 75.1029 1.45044 74.9571 2.95868C74.8875 3.25583 75.5095 1.24645 66.412 30.2483C66.2257 31.1333 65.6312 32.0296 64.3579 31.914H61.3302C59.558 32.0987 59.3037 30.3624 59.2761 30.1873L53.9044 8.16121L48.5943 30.1648C48.5684 30.3399 48.314 32.0762 46.5402 31.8915H43.5757V31.8931ZM87.8778 32.7974C86.9252 32.799 82.3829 32.7492 78.5858 30.8233C78.2076 30.6645 77.8854 30.398 77.6602 30.0574C77.4349 29.7168 77.3167 29.3176 77.3206 28.9103V27.1837C77.3206 25.8264 78.325 26.0754 78.751 26.2376C80.3775 26.8897 81.4207 27.3844 83.4181 27.7796C89.3551 28.989 91.9665 27.4101 92.6064 27.06C94.7366 25.8055 94.9051 22.9352 93.4568 21.4462C91.7591 20.0344 90.9492 19.9814 84.8501 18.0732C84.0985 17.866 77.771 15.8871 77.7564 9.66303C77.6576 5.12707 81.8143 0.639297 89.0182 0.67624C91.0707 0.674634 96.5396 1.33961 98.0202 3.18515C98.2389 3.52085 98.3474 3.91598 98.3312 4.31593V5.93982C98.3312 6.65298 98.0688 7.00956 97.5423 7.00956C96.2933 6.87142 94.0773 5.21541 89.5787 5.28287C88.4626 5.22505 83.1168 5.42904 83.3565 9.2936C83.2869 12.339 87.6672 13.481 88.1677 13.6127C94.074 15.3747 96.0487 15.6671 98.3928 18.3639C101.169 21.9377 99.6725 26.1219 99.0975 27.2688C96.0066 33.2905 88.0138 32.8006 87.8778 32.7974ZM94.3899 49.6402C83.0455 57.9475 66.5772 62.3695 52.5162 62.3695C33.5435 62.4935 15.2103 55.5763 1.12039 42.9776C0.0625718 42.0315 0.995656 40.7353 2.28189 41.4565C17.9118 50.3215 35.6081 54.9794 53.6145 54.968C67.0611 54.8965 80.3611 52.1918 92.7505 47.0092C94.6588 46.2061 96.2771 48.262 94.3899 49.6402ZM99.1185 44.2931C97.6671 42.4427 89.5155 43.4289 85.8658 43.861C84.7659 43.9847 84.5796 43.0386 85.5758 42.3399C92.0669 37.8152 102.728 39.1114 103.952 40.6325C105.175 42.1536 103.62 52.745 97.5439 57.8046C96.6108 58.5868 95.7183 58.174 96.133 57.146C97.5002 53.7328 100.57 46.1451 99.1185 44.2931Z"
                fill="#737373"
              ></path>
            </g>
            <defs>
  ...
  <div className="flex-grow-0 flex-shrink-0 w-[1440px] h-[636px] relative overflow-hidden bg-[#2a7cc7]">
    ...
    <div
      className="flex flex-col justify-start items-start absolute left-[195px] top-0 overflow-hidden py-28"
    >
      <div
        className="flex justify-between items-center flex-grow-0 flex-shrink-0 w-[1050px] relative overflow-hidden"
      >
        <div
          className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[438px] relative overflow-hidden gap-6"
        >
          <p className="flex-grow-0 flex-shrink-0 text-base font-bold text-left text-white">
            WORK WITH US
          </p>
          <p className="flex-grow-0 flex-shrink-0 text-[40px] font-bold text-left text-white">
            Now Let’s grow Yours
          </p>
          <p className="flex-grow-0 flex-shrink-0 w-[440px] text-sm text-left text-white">
            The gradual accumulation of information about atomic and small-scale behavior during the
            first quarter of the 20th
          </p>
          <div
            className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative overflow-hidden gap-2.5 px-10 py-[15px] rounded-[5px] border border-neutral-50"
          >
            <p className="flex-grow-0 flex-shrink-0 text-sm font-bold text-center text-neutral-50">
              Button
            </p>
          </div>
        </div>
        <div className="flex-grow-0 flex-shrink-0 w-[548px] h-[412px] relative overflow-hidden"></div>
      </div>
    </div>
  </div>
